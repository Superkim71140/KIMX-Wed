...
export default function ProcessSection() {
  ...
  const slides = steps.map((step) => (
    <div key={step.num} className="h-full px-2 py-4">
      <div className="bg-white border border-slate-100 rounded-4xl p-8 relative flex flex-col items-start h-full min-h-[380px] hover-slow-smooth shadow-[0_4px_20px_rgba(0,0,0,0.03)] group portfolio-card-gpu">
  ...
  return (
    <section id="process" className="relative py-24 sm:py-32 bg-transparent overflow-hidden scroll-mt-20">
      {/* Glow background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[80%] bg-linear-to-tr from-transparent via-sky-200/10 to-transparent filter blur-[100px] pointer-events-none" />
      ...
      <Container className="relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto z-10 relative mb-12">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight mb-4" data-aos="fade-up">
            ...
            <span className="bg-linear-to-r from-teal-400 via-teal-500 to-cyan-500 bg-clip-text text-transparent inline-block">
              อย่างเป็นระบบ
            </span>
          </h2>
