...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className="sticky top-0 w-full z-[100] h-[72px] sm:h-[88px] flex items-center transition-all duration-300 bg-slate-950/85 backdrop-blur-xl border-b border-white/10 shadow-lg"
      >
